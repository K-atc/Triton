...
This namespace come from the `unicorn` module. The INSERT_POINT namespace contains all kinds of insert points.
...
This namespace come from the `unicorn` module. The STANDARD namespace contains all kinds of syscall standard.
...
namespace tracer {
  namespace unicorn {
    ...
    void initBindings(void) {
      ...
      PyDict_SetItemString(idCallbackClassDict, "AFTER",            triton::bindings::python::PyLong_FromUint32(tracer::unicorn::options::CB_AFTER));
      PyDict_SetItemString(idCallbackClassDict, "BEFORE",           triton::bindings::python::PyLong_FromUint32(tracer::unicorn::options::CB_BEFORE));
      PyDict_SetItemString(idCallbackClassDict, "BEFORE_SYMPROC",   triton::bindings::python::PyLong_FromUint32(tracer::unicorn::options::CB_BEFORE_SYMPROC));
      PyDict_SetItemString(idCallbackClassDict, "FINI",             triton::bindings::python::PyLong_FromUint32(tracer::unicorn::options::CB_FINI));
      PyDict_SetItemString(idCallbackClassDict, "ROUTINE_ENTRY",    triton::bindings::python::PyLong_FromUint32(tracer::unicorn::options::CB_ROUTINE_ENTRY));
      PyDict_SetItemString(idCallbackClassDict, "ROUTINE_EXIT",     triton::bindings::python::PyLong_FromUint32(tracer::unicorn::options::CB_ROUTINE_EXIT));
      PyDict_SetItemString(idCallbackClassDict, "SIGNALS",          triton::bindings::python::PyLong_FromUint32(tracer::unicorn::options::CB_SIGNALS));
      PyDict_SetItemString(idCallbackClassDict, "SYSCALL_ENTRY",    triton::bindings::python::PyLong_FromUint32(tracer::unicorn::options::CB_SYSCALL_ENTRY));
      PyDict_SetItemString(idCallbackClassDict, "SYSCALL_EXIT",     triton::bindings::python::PyLong_FromUint32(tracer::unicorn::options::CB_SYSCALL_EXIT));
      PyDict_SetItemString(idCallbackClassDict, "IMAGE_LOAD",       triton::bindings::python::PyLong_FromUint32(tracer::unicorn::options::CB_IMAGE_LOAD));
      ...
      PyDict_SetItemString(idStandardClassDict, "STANDARD_INVALID",             triton::bindings::python::PyLong_FromUint32(0xdeadbeef));
      PyDict_SetItemString(idStandardClassDict, "STANDARD_IA32_LINUX",          triton::bindings::python::PyLong_FromUint32(0xdeadbeef));
      PyDict_SetItemString(idStandardClassDict, "STANDARD_IA32E_LINUX",         triton::bindings::python::PyLong_FromUint32(0xdeadbeef));
      PyDict_SetItemString(idStandardClassDict, "STANDARD_IA32_MAC",            triton::bindings::python::PyLong_FromUint32(0xdeadbeef));
      PyDict_SetItemString(idStandardClassDict, "STANDARD_IA32E_MAC",           triton::bindings::python::PyLong_FromUint32(0xdeadbeef));
      PyDict_SetItemString(idStandardClassDict, "STANDARD_IA32_WINDOWS_FAST",   triton::bindings::python::PyLong_FromUint32(0xdeadbeef));
      PyDict_SetItemString(idStandardClassDict, "STANDARD_IA32E_WINDOWS_FAST",  triton::bindings::python::PyLong_FromUint32(0xdeadbeef));
      PyDict_SetItemString(idStandardClassDict, "STANDARD_IA32_WINDOWS_ALT",    triton::bindings::python::PyLong_FromUint32(0xdeadbeef));
      PyDict_SetItemString(idStandardClassDict, "STANDARD_WOW64",               triton::bindings::python::PyLong_FromUint32(0xdeadbeef));
      PyDict_SetItemString(idStandardClassDict, "STANDARD_WINDOWS_INT",         triton::bindings::python::PyLong_FromUint32(0xdeadbeef));
      /* Create the STANDARD class */
      PyObject *idStandardClass = triton::bindings::python::xPyClass_New(nullptr, idStandardClassDict, idStandardClassName);

      /* ======================= */

      /* Add namespace into the unicorn module */
      PyModule_AddObject(unicornModule, "INSERT_POINT", idCallbackClass);
      PyModule_AddObject(unicornModule, "STANDARD", idStandardClass);
    }
    ...
    bool execScript(const char *fileName) {
      ...
      if (!handle)
        throw std::runtime_error("tracer::unicorn::execScript(): Cannot load the Python library.");
      #endif
